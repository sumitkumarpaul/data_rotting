...
int du_input_check(int argc, char *argv[])
{
    ...
    printf("      - access-data:  Access previously obtained data and return the result of the computation to the data-user:\n");
    printf("                      Required inputs are: <IP address of the trusted time-stamping server> <Port of the trusted time-stamping server>\n");
