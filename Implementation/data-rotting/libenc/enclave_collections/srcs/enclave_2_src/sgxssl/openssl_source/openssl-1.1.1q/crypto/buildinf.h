...
#define DATE "built on: Thu Jan 12 01:39:12 2023 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','i',
    'n','c','l','u','d','e','/','h','o','m','e','/','u','b','u','n',
    't','u','/','I','n','t','e','l','-','S','G','X','-','S','D','K',
    '-','e','x','p','e','r','i','m','e','n','t','a','t','i','o','n',
    '/','s','g','x','s','d','k','/','p','h','d','-','u','o','t','t',
    'a','w','a','-','r','e','s','e','a','r','c','h','/','R','e','s',
    'e','a','r','c','h','/','D','a','t','a','_','r','o','t','t','i',
    'n','g','/','P','o','P','E','T','S','_','2','3','_','S','G','X',
    '_','D','a','t','a','_','R','o','t','t','i','n','g','/','I','m',
    'p','l','e','m','e','n','t','a','t','i','o','n','/','d','a','t',
    'a','-','r','o','t','t','i','n','g','/','l','i','b','e','n','c',
    '/','e','n','c','l','a','v','e','_','c','o','l','l','e','c','t',
    'i','o','n','s','/','s','r','c','s','/','e','n','c','l','a','v',
    'e','_','1','_','s','r','c','/','s','g','x','s','s','l','/','L',
    'i','n','u','x','/','.','.','/','o','p','e','n','s','s','l','_',
    's','o','u','r','c','e','/','b','y','p','a','s','s','_','t','o',
    '_','s','g','x','s','s','l','.','h',' ','-','D','O','P','E','N',
    ...
    'M',' ','-','D','N','D','E','B','U','G',' ','-','D','_','F','O',
    'R','T','I','F','Y','_','S','O','U','R','C','E','=','2',' ','-',
    'D','G','E','T','P','I','D','_','I','S','_','M','E','A','N','I',
    'N','G','L','E','S','S','\0'
};
