...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-Wall -O3", "-include/home/ubuntu/Intel-SGX-SDK-experimentation/sgxsdk/phd-uottawa-research/Research/Data_rotting/PoPETS_23_SGX_Data_Rotting/Implementation/data-rotting/libenc/enclave_collections/srcs/enclave_1_src/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
  CPPDEFINES => [ "_FORTIFY_SOURCE=2", "GETPID_IS_MEANINGLESS" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "-include/home/ubuntu/Intel-SGX-SDK-experimentation/sgxsdk/phd-uottawa-research/Research/Data_rotting/PoPETS_23_SGX_Data_Rotting/Implementation/data-rotting/libenc/enclave_collections/srcs/enclave_1_src/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
