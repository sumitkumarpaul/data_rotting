...
openssl x509 -req -days 3650 -in sample_do_pri_data.csr -CA sample_di_cert.pem -CAkey sample_di_pri_key.pem -CAcreateserial -out sample_do_pri_data_cert.pem -extensions v3_req -extfile sample_do_pri_data.conf -set_serial 01
